...
from tests.paths import KB_ROOT
...
def test_runtime_schema_loads_ru_and_en() -> None:
    ...
    ru = load_runtime_schema_for_language("ru", str(KB_ROOT)).schema
    en = load_runtime_schema_for_language("en", str(KB_ROOT)).schema
...
def test_schema_has_policy_binding_for_each_category() -> None:
    ...
    schema = load_runtime_schema_for_language("ru", str(KB_ROOT)).schema
...
def test_runtime_schema_context_loads_ru() -> None:
    ...
    context = load_runtime_schema_for_language("ru", str(KB_ROOT))
...
def test_faq_regex_extracts_english_pairs() -> None:
    ...
    schema = load_runtime_schema_for_language("en", str(KB_ROOT)).schema
