...
from src.core.config import DBSettings, Settings, get_kb_language, settings
from src.core.db_manager import DBManager
from src.core.faiss_manager import faiss_manager
from src.core.logs import logger
from src.db.init_db import init_db
from src.db.session import SessionLocal, dispose_engine
from src.exceptions import handle_basic_db_errors
from src.exceptions.ingest import IngestInterruptedError
...
from src.models.index_manifest import IndexManifest
from src.schemas.etl import ChunkStatsResponse, IngestAllResponse, IngestResponse, ManifestResponse
from src.services.etl_checkpoint import IngestCheckpoint, IngestCheckpointStore
from src.services.etl_plan import plan_ingest
from src.services.etl_progress import IngestProgress, IngestProgressCallback
from src.etl.chunking_schema import (
...
from src.etl.document_warnings import emit_duplicate_section_number_warnings
    ...
    async def ingest_all(
        ...
        *,
        ...
        return await self.ingest_directory(
            schemas_dir=self.settings.resolve_data_dir(),
            rebuild=rebuild,
            on_progress=on_progress,
        )
